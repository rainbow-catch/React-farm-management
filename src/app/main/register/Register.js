        ...
        <div className={clsx(classes.root, "flex flex-col flex-1 flex-shrink-0 p-24 md:flex-row md:p-0")}>
            ...
            <div className="flex flex-col flex-grow-0 items-center text-white p-16 text-center md:p-128 md:items-start md:flex-shrink-0 md:flex-1 md:text-left">
                ...
                <FuseAnimate animation="transition.expandIn">
                    <img className="w-70 mb-50" src="assets/images/logos/KOSMO_SAT2.svg" alt="logo" />
                </FuseAnimate>

                <FuseAnimate animation="transition.slideUpIn" delay={300}>
                    <Typography variant="h3" color="inherit" className="font-light">
                        Welcome to Kestrel Data!
                    </Typography>
                </FuseAnimate>
            ...
            <FuseAnimate animation={{ translateX: [0, '100%'] }}>
                ...
                <Card className="w-full max-w-200 mx-auto m-16 md:m-0" square>

                    <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">

                        <Typography variant="h4" className="md:w-full mb-32">CREATE AN ACCOUNT</Typography>
