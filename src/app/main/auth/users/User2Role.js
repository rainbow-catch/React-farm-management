        ...
        <FusePageSimple
            ...
            header={
                <div className="flex flex-1 items-center justify-between p-24">
                    <Typography className="h2">Users2  Auth role example page</Typography>
                    <Button
                    ...
                    <FuseHighlight component="pre" className="language-js">
                        {`
                            ...
                            export const StaffRoleExampleConfig = {
                                ...
                                auth    : authRoles.user2,//['admin',staff']
                                routes  : [
                                    {
                                        path     : '/auth/users',
                                        component: User2Role
                    ...
                    <FuseHighlight component="pre" className="language-json">
                        {`
                                export const fuseNavigationConfig = [
                                   {
                                        'id'   : 'only-User2-navigation-item',
                                        'title': 'Nav item only for user2',
                                        'type' : 'item',
                                        'auth' : authRoles.user2,//['admin','staff']
                                        'url'  : '/auth/User2Role',
                                        'icon' : 'verified_user'
