    ...
    return (
        <div className={clsx(classes.root, "flex flex-grow flex-shrink-0 flex-col items-center")}>
            ...
            <div className="flex flex-grow flex-shrink-0 flex-col items-center container px-16 md:px-24">
                ...
                <FuseAnimate>
                    <Typography className="mt-44 sm:mt-88 sm:py-24 text-32 sm:text-40 font-300" color="inherit">Fazenda  de gado</Typography>
                </FuseAnimate>
                    ...
                    >
                        ...
                        <div className="w-224 h-224 p-16">
                            ...
                            >
                                ...
                                <Typography className="text-16 font-300 text-center pt-16 px-32" color="inherit">Add Fazenda</Typography>
                            </div>
                        </div>
                    </FuseAnimateGroup>
                </div>
