        ...
        <FusePageCarded
                        ...
                        <div className="flex flex-col items-start max-w-full">
                            ...
                            <div className="flex items-center max-w-full">
                                ...
                                <div className="flex flex-col min-w-0">
                                    ...
                                    <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                                        <Typography variant="caption">Detalhes do produto</Typography>
                                    </FuseAnimate>
                                </div>
                            </div>
                        </div>
            ...
            contentToolbar={
                ...
                >
                    ...
                    <Tab className="h-64 normal-case" label="Monitoramento de produtos" />
                    <Tab className="h-64 normal-case" label="Imagens do produto" />
                    <Tab className="h-64 normal-case" label="Preço" />
                    <Tab className="h-64 normal-case" label="Inventário" />
                    <Tab className="h-64 normal-case" label="Logística" />
                </Tabs>
            }
            content={
                form && (
                            ...
                            (
                                ...
                                >
                                    ...
                                    <iframe title="myFrame" style={{
                                        ...
                                        src={"https://jespavon.users.earthengine.app/view/barbandvimerlotabril"}
                                        frameBorder="0"
                                    />
                                </div>
                            )}
