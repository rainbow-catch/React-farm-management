        ...
        <Card className="w-full rounded-8 shadow-none border-1">
            ...
            <AppBar position="static">
                ...
                <div className="p-16 pr-4 flex flex-row items-center justify-between">
                    ...
                    <div className="pr-16">
                        <Typography className="h1 font-300" color="inherit">VID Espanha</Typography>
                        <Typography className="h5" color="inherit">Evolução do mercado</Typography>
                    </div>
                ...
                <Tabs
                    ...
                    variant="fullWidth"
                >
                    <Tab label="1Dia" className="min-w-0" />
                    <Tab label="1Semana" className="min-w-0" />
                    <Tab label="1Mes" className="min-w-0" />
                </Tabs>
            </AppBar>
            <Line
                data={{
