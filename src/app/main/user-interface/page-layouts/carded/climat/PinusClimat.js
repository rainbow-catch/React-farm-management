...
function PinusClimat() {
    ...
    return (
        <FusePageCarded
            ...
            header={
                <div className="py-24"><h3>Pinus elliotti</h3></div>
            }
            contentToolbar={
                <Tabs
                    value={selectedTab}
                        ...
                        (
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://ivanacopavon.users.earthengine.app/view/temperaturemean"}
                                    frameBorder="0"
                                />
                            </div>
                        )}
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://ivanacopavon.users.earthengine.app/view/precipitacin"}
                                    frameBorder="0"
                                />
                            </div>
                            )}
