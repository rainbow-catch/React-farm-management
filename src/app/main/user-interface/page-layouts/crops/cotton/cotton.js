...
function Cotton() {
    ...
    return (
        <FusePageSimple
            ...
            header={
                <div className="p-24"><h3>Algodón</h3></div>
            }
            contentToolbar={
                <Tabs
                    value={selectedTab}
                        ...
                        (
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/cottonmonito"}
                                    frameBorder="0"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/cottonnut"}
                                    frameBorder="0"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/cottonsoil"}
                                    frameBorder="0"
                                />
                            </div>
                        </div>
