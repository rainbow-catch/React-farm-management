...
function pcaribaea() {
    ...
    return (
        <FusePageSimple
            ...
            header={
                <div className="p-24"><h3>Pinus elliotti</h3></div>
            }
            contentToolbar={
                <Tabs
                    value={selectedTab}
                        ...
                        (
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://ivanacopavon.users.earthengine.app/view/seobentondvipcabajune"}
                                    frameBorder="0"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://ivanacopavon.users.earthengine.app/view/nutpcarabahajune"}
                                    frameBorder="0"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://ivanacopavon.users.earthengine.app/view/soilpcarabamejune"}
                                    frameBorder="0"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://ivanacopavon.users.earthengine.app/view/alertjune"}
                                    frameBorder="0"
                                />
                            </div>
                        </div>
