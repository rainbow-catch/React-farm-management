...
function Coffe() {
    ...
    return (
        <FusePageSimple
            ...
            header={
                <div className="p-24"><h3>Café</h3></div>
            }
            contentToolbar={
                <Tabs
                    value={selectedTab}
                        ...
                        (
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/coffeendvi"}
                                    frameBorder="0"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/coffee"}
                                    frameBorder="0"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/coffesoil"}
                                    frameBorder="0"
                                />
                            </div>
                        </div>
