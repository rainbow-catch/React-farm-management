...
function Almonds() {
    ...
    return (
        <FusePageSimple
            ...
            header={
                <div className="p-24"><h3>Almendros</h3></div>
            }
            contentToolbar={
                <Tabs
                    value={selectedTab}
                        ...
                        (
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/borgesndvijune"}
                                    frameBorder="0"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/borgesnutritationjune"}
                                    frameBorder="0"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/borgessoiljuly"}
                                    frameBorder="0"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/borgesalertjuly"}
                                    frameBorder="0"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <iframe title="myFrame" style={{
                                    ...
                                    src={"https://jespavon.users.earthengine.app/view/borgesfusionjune"}
                                    frameBorder="0"
                                />
                            </div>
